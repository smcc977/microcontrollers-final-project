...
#define GPTM_CFG_32BITTIMER       (0x0 << 0)        // 32-bit timer
#define GPTM_CFG_32BITRTC         (0x1 << 0)        // 32-bit RTC
#define GPTM_CFG_16BITTIMERS      (0x4 << 0)        // 2 16-bit timers
  GPTM_TAMR =   (0x004 >> 2),
#define GPTM_TAMR_TAMR_M        (0b11 << 0)     // GPTM Timer A Mode
#define GPTM_TAMR_TAMR_ONESHOT    (0x1 << 0)        // One-Shot Timer mode
#define GPTM_TAMR_TAMR_PERIODIC   (0x2 << 0)        // Periodic Timer mode
#define GPTM_TAMR_TAMR_CAP        (0x3 << 0)        // Capture mode
