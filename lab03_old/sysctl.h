...
#define   SYSCTL_RCGCGPIO_PORTJ     (1 << 8) //PortJ clock gating control
#define   SYSCTL_RCGCGPIO_PORTD     (1 << 3) //PortJ clock gating control
#define   SYSCTL_RCGCGPIO_PORTE     (1 << 4) //PortJ clock gating control
#define   SYSCTL_RCGCGPIO_PORTL     (1 << 10) //PortL clock gating control
#define   SYSCTL_RCGCGPIO_PORTF     (1 << 5) //PortA clock gating control
